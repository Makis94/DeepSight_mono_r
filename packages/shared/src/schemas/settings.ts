...
export const TRADE_THRESHOLD_PRESETS = ["10000", "50000", "100000", "500000"] as const;
...
// own DEPOSIT_MIN_NOTIONAL_USD floor (apps/worker/.env) — that floor decides whether an
// event is written at all, these decide what a user sees on top of that. Lowest preset here
// ($5k) is intentionally well below CLAUDE.md's "$500k+" spec example — that's still
// available as the third preset; $5k/$100k give users (and testing) finer-grained options.
export const DEPOSIT_THRESHOLD_PRESETS = ["5000", "100000", "500000", "1000000"] as const;
...
export const TWAP_THRESHOLD_PRESETS = ["10000", "50000", "100000", "500000"] as const;
